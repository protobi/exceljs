...
class ContentTypesXform extends BaseXform {
  render(xmlStream, model) {
    ...
    (model.pivotTables || []).forEach((pivotTable, index) => {
      ...
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotCache/pivotCacheDefinition${tableNum}.xml`,
        ContentType:
          'application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheDefinition+xml',
      });
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotCache/pivotCacheRecords${tableNum}.xml`,
        ContentType:
          'application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheRecords+xml',
      });
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotTables/pivotTable${tableNum}.xml`,
        ContentType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.pivotTable+xml',
      });
    });

    // Content types for preserved pivot tables (from round-trip)
    if (model.preservedPivotTables) {
      Object.keys(model.preservedPivotTables.pivotTables || {}).forEach(name => {
    ...
    // Content types for preserved drawings (with charts)
