...
class Row {
  ...
  get model() {
    ...
    // Only include dyDescent if it was set
    if (this.dyDescent !== undefined) {
      model.dyDescent = this.dyDescent;
    }

    return this.height || cells.length ? model : null;
  }
